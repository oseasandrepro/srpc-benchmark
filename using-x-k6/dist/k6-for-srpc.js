...
var Encoder = class _Encoder {
  constructor(options2) {
    ...
    this.extensionCodec = (_a = options2 == null ? void 0 : options2.extensionCodec) != null ? _a : ExtensionCodec.defaultCodec;
    this.context = options2 == null ? void 0 : options2.context;
    this.useBigInt64 = (_b = options2 == null ? void 0 : options2.useBigInt64) != null ? _b : false;
    this.maxDepth = (_c = options2 == null ? void 0 : options2.maxDepth) != null ? _c : DEFAULT_MAX_DEPTH;
    this.initialBufferSize = (_d = options2 == null ? void 0 : options2.initialBufferSize) != null ? _d : DEFAULT_INITIAL_BUFFER_SIZE;
    this.sortKeys = (_e = options2 == null ? void 0 : options2.sortKeys) != null ? _e : false;
    this.forceFloat32 = (_f = options2 == null ? void 0 : options2.forceFloat32) != null ? _f : false;
    this.ignoreUndefined = (_g = options2 == null ? void 0 : options2.ignoreUndefined) != null ? _g : false;
    this.forceIntegerToFloat = (_h = options2 == null ? void 0 : options2.forceIntegerToFloat) != null ? _h : false;
    this.pos = 0;
...
function encode(value, options2) {
  const encoder = new Encoder(options2);
...
var Decoder = class _Decoder {
  constructor(options2) {
    ...
    this.context = options2 == null ? void 0 : options2.context;
    this.useBigInt64 = (_b = options2 == null ? void 0 : options2.useBigInt64) != null ? _b : false;
    this.rawStrings = (_c = options2 == null ? void 0 : options2.rawStrings) != null ? _c : false;
    this.maxStrLength = (_d = options2 == null ? void 0 : options2.maxStrLength) != null ? _d : UINT32_MAX;
    this.maxBinLength = (_e = options2 == null ? void 0 : options2.maxBinLength) != null ? _e : UINT32_MAX;
    this.maxArrayLength = (_f = options2 == null ? void 0 : options2.maxArrayLength) != null ? _f : UINT32_MAX;
    this.maxMapLength = (_g = options2 == null ? void 0 : options2.maxMapLength) != null ? _g : UINT32_MAX;
    this.maxExtLength = (_h = options2 == null ? void 0 : options2.maxExtLength) != null ? _h : UINT32_MAX;
    this.keyDecoder = (options2 == null ? void 0 : options2.keyDecoder) !== void 0 ? options2.keyDecoder : sharedCachedKeyDecoder;
    this.mapKeyConverter = (_i = options2 == null ? void 0 : options2.mapKeyConverter) != null ? _i : mapKeyConverter;
  }
  clone() {
    return new _Decoder({
      extensionCodec: this.extensionCodec,
  ...
  *decodeMulti(buffer) {
    if (this.entered) {
      const instance = this.clone();
      yield* __yieldStar(instance.decodeMulti(buffer));
      return;
    }
    try {
      this.entered = true;
  ...
  decodeMultiAsync(stream, isArray) {
    return __asyncGenerator(this, null, function* () {
      if (this.entered) {
        const instance = this.clone();
        yield* __yieldStar(instance.decodeMultiAsync(stream, isArray));
        return;
      }
      try {
        this.entered = true;
...
function decode(buffer, options2) {
  const decoder = new Decoder(options2);
  return decoder.decode(buffer);
}

// k6-for-srpc.js
import { Counter } from "k6/metrics";
var srpcErrors = new Counter("rpc_errors");
var options = {
  scenarios: {
    throughput_test: {
  ...
  return __async(this, null, function* () {
    ...
    return new Promise((resolve, reject) => __async(null, null, function* () {
      ...
      socket.on("data", (data) => {
        ...
        buffer = combined;
        if (expectedPayloadSize === null && buffer.length >= HEADER_SIZE) {
          ...
          expectedPayloadSize = view.getUint32(4, false);
          if (code !== 0) {
            srpcErrors.add(1);
            console.log("srpcError");
          }
        }
        if (expectedPayloadSize !== null && buffer.length >= HEADER_SIZE + expectedPayloadSize) {
          try {
      ...
      try {
        yield socket.connect(PORT, HOST);
...
function k6_for_srpc_default() {
  return __async(this, null, function* () {
    const result = yield remoteCall(0, [100]);
  });
}
export {
  k6_for_srpc_default as default,
  options
};
